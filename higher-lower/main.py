...
def get_choice():
    ...
    return answers, first_followers, second_followers, first_choice_index
...
answers, first_followers, second_followers, first_choice_index = get_choice()
...
while bad_answer == 0:
    ...
    if usr_input == 'H' and first_followers < second_followers:
        ...
        os.system('cls')
        print("Let's goo")
        another_choice(first_choice_index, answers)
